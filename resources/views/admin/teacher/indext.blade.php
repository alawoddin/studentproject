            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="flex items-center mb-4 md:mb-0">
                    <div class="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center overflow-hidden">
                        ...
                        <img src="https://avatars.githubusercontent.com/u/127109165?v=4" alt="">
                    </div>
                    <div class="ml-4">
                        <h1 class="text-2xl font-bold text-gray-800">
                            Hashmatullah Mohammadi
                        </h1>
                        <p class="text-gray-600">Web Development Instructor</p>
                    </div>
                </div>
                <div class="bg-blue-50 text-blue-800 px-4 py-2 rounded-lg">
                    <p class="flex items-center">
                        <i class="fas fa-chalkboard-teacher mr-2"></i>
                        <span>Total Classes: 6</span>
                    </p>
                </div>
            </div>
        </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="card bg-white rounded-xl p-6">
                <div class="flex justify-between items-start">
                    <div>
                        <h3 class="text-lg font-medium text-gray-700">html class</h3>
