                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store.depart') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="depart_name" type="text" placeholder="Department name">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="depart_subject" type="text" placeholder="Department subject">
                            </div>
                        </div>
