...
@section('teacher')
    <div class="container-fluid">
        ...
        @php
            ...
            $profile = App\Models\Teacher::with('department')->find($id);
        @endphp
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0">
                                        <span class="text-success fw-bold font-size-12 me-2">
                                            <i class="ri-arrow-right-up-line me-1 align-middle"></i>ID : {{ $profile->roll_id }}
                                        </span>
                                        Department :  <strong>{{ $profile->department->depart_name }}</strong>
                                    </p>
                                </div>
                                <div class="avatar-sm">
